...
The -configuration option will execute the single configuration json file pointed to by the second argument. This configuration file must be in the /config folder. Eg: ./run.sh -configuration ga_default_25.json
...
The pso algorithm showed mixed results, with certain configurations yielding very high quality (above 100%) solutions, while other configurations show little improvement from the starting solution at all. This algorithm seems to converge very quickly, and I am not sure how to further encourage exploration.
